...
# permission_prompt | elicitation_dialog) and Pi's ui_prompt_start event.
# Marks this pane as waiting on the user's input: red border, and a red
# window title via the derived flags in agent-pane-state.sh. The
