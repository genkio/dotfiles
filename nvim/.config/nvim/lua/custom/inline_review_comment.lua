...
function M.open(from_visual, mode)
  ...
  vim.keymap.set('n', 'q', close_float, { buffer = float_buf, desc = 'Review comment: cancel' })
  vim.keymap.set('n', '<Esc>', close_float, { buffer = float_buf, desc = 'Review comment: cancel' })
